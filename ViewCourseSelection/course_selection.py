...
import CommonLogic.utils as utils
import ViewCourseSelection.timetable as timetable
import ViewCourseSelection.course_manager as course_manager
        ...
        if st.session_state["page"] == 1:
            ...
            if selected_subject:
                ...
                if distribution_button:
                    ...
                    if not data.empty:
                        st.bar_chart(
                            data, x="course_number", y="selection_number", color="year"
                        )
                    else:
        ...
        # student
            ...
            if timetable_button:
                ...
                for index, row in data.iterrows():
                    ...
                    sections.append(
                        [course_key, type_code, days_of_week, start_time, end_time]
                    )

                selected_sections = course_manager.find_best(
                    course_manager.get_combinations(sections)
                )
